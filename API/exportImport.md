...
- Уровни иерархии справочников визуально выделяются "лесенкой" по аналогии с веб-интерфейсом. Импорт такого файла с итоговыми строками на данный момент недоступен.
