...
Если элементы эквивалентны в смысле переданных списков свойств, никаких действий не предпринимается. Если же не совпадают какие-то свойства, выполняется перезаписать всех свойств, кроме нулевого, с помощью [`CellBuffer`](../API/common.md#CellBuffer):
...
Далее следует [создать](../API/elementsManipulator.md#NumericElementsCreator) элементы справочника-приёмника:
