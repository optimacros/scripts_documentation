...
wait(wait: number): ResultTaskAction|null
```
Устанавливает время ожидания разрешения промиса в секундах. Возвращает [`ResultTaskAction`](#result-task-action), если ответ пришёл в рамках установленного времени, иначе `null`.
