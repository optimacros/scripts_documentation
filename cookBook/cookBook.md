...
Раздел создан как демонстрация API, чтобы у программистов, начинающих работать с платформой, были примеры рабочего кода, демонстрирующие основные интерфейсы, методы и подходы. Не стоит воспринимать данный раздел как источник лучших практик: примеры местами намеренно упрощены в демонстационных целях.
