...
setCurrentMacrosStorageReadMode(type: string): boolean
```
Устанавливает режим чтения данных модели для текущего скрипта. Параметр `type` принимает одно из значений `'CONSISTENT_READ'`, `'FAST_READ'`, `'FAST_READ_METADATA'`. Читайте описание режимов в разделе [`Режимы чтения и записи данных`](../advancedFeatues/readWriteModes.md#read-mode). Возвращает `true`.
...
setModelStorageReadMode(type: string): boolean;
```
Устанавливает режим чтения данных модели для пользователей. Аналог в интерфейсе `Optimacros`: `Меню пользователя` -> `Параметры` -> `Режимы чтения и записи` -> `Режим чтения для пользователей`. Параметр `type` принимает одно из значений `'CONSISTENT_READ'`, `'FAST_READ'`, `'FAST_READ_METADATA'`. Читайте описание режимов в разделе [`Режимы чтения и записи данных`](../advancedFeatues/readWriteModes.md#read-mode). Возвращает `true`.
...
setModelStorageWriteMode(type: string): boolean;
```
Устанавливает режим записи данных в модель. Аналог в интерфейсе `Optimacros`: `Меню пользователя` -> `Параметры` -> `Режимы чтения и записи` -> `Режим записи для пользователей и скриптов`. Параметр `type` принимает одно из значений `'CONSISTENT_WRITE'`, `'FAST_WRITE'`. Читайте описание режимов в разделе [`Режимы чтения и записи данных`](../advancedFeatues/readWriteModes.md#write-mode). Возвращает `true`.
...
setMacrosStorageReadMode(type: string): boolean
```
Устанавливает режим чтения данных модели для скриптов. Аналог в интерфейсе `Optimacros`: `Меню пользователя` -> `Параметры` -> `Режимы чтения и записи` -> `Режим чтения для скриптов`. Параметр `type` принимает одно из значений `'CONSISTENT_READ'`, `'FAST_READ'`, `'FAST_READ_METADATA'`. Читайте описание режимов в разделе [`Режимы чтения и записи данных`](../advancedFeatues/readWriteModes.md#read-mode). Метод ожидает завершения всех запросов в модели и только после переключает режим. Возвращает `true`.
