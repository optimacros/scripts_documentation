...
enableCustomProperties(): CopyData
```
Предписывает произвести копирование данных из свойств элемента-источника в свойства элемента-приёмника в пользовательских свойствах всех справочников модели, которые содержат *заданное измерение*.
