...
Максимальный размер фильтра: `50000` строк. Если передать в фильтре большее количество строк, то метод не выбрасывает ошибку, но грид будет отфильтрован только по первым `50000` строкам фильтра.
