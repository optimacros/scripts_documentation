...
* Добавлен функционал синхронизации мультикубов и справочников: функция `syncMulticube()` интерфейса [`Multicubes`](../API/OMviews.md#Multicubes), интерфейсы [`SyncBuilder`](#SyncBuilder), [`SyncMulticubeBuilder`](../API/OMviews.md#SyncMulticubeBuilder), [`SyncResult`](#SyncResult).
