...
[Скрипт](./scripts/partialListCopy_v1.0.js) и [пример](./scripts/partialListCopy_ENV.js) частичного копирование справочников его настроек.
...
Последняя првоерка необходима потому, что скрипт не сопоставляет свойства разных справочников по именам, а может копировать свойство `'p1'` справочника `L1` в свойство `'p2'` справочника `L2`.
...
Если элементы эквивалентны в смысле переданных списков свойств, делать ничего не нужно. Если же не совпадают какие-то свойства, перезапишем все свойства, кроме нулевого, с помощью [`CellBuffer`](../API/common.md#CellBuffer):
...
Теперь мы [создаём](../API/elementsManipulator.md#NumericElementsCreator) элементы справочника-приёмника:
