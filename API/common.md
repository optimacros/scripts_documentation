...
### Интерфейс ButtonInfoOptions ...<a name="ResultBaseAction"></a>
...
### Интерфейс ButtonInfo ...<a name="ResultBaseAction"></a>
...
### Интерфейс EnvironmentInfo<a name="ResultBaseAction"></a>
...
```
Интерфейс [`переменных окружения`](https://ru.wikipedia.org/wiki/%D0%9F%D0%B5%D1%80%D0%B5%D0%BC%D0%B5%D0%BD%D0%BD%D0%B0%D1%8F_%D1%81%D1%80%D0%B5%D0%B4%D1%8B).
...
setAutoRunTimeout(seconds: number): this
```
Устанавливает тайм-аут запуска скрипта в секундах. Значение по умолчанию: `0`. Возвращает `this`.
